...
const FunFact = () => {
  return (
    <>
      {/* <!-- ===== Funfact Start ===== --> */}
      <section className="px-4 py-20 md:px-8  2xl:px-0">
        <div className="relative z-1 mx-auto max-w-c-1390 rounded-lg bg-gradient-to-t from-[#F8F9FF] to-[#DEE7FF] py-22.5 dark:bg-blacksection dark:bg-gradient-to-t dark:from-transparent dark:to-transparent dark:stroke-strokedark xl:py-27.5">
          ...
          >
            <h2 className="mb-4 text-3xl font-bold text-black dark:text-white ">
              Trusted By Companies Country Wide
            </h2>
          ...
          <div className="flex flex-wrap justify-center gap-8 lg:gap-42.5">
            ...
            >
              <h3 className="mb-2.5 text-3xl font-bold text-black dark:text-white">
                300
              </h3>
              <p className="text-lg">Country Wide Clients</p>
            </motion.div>
            <motion.div
              variants={{
                hidden: {
            ...
            >
              ...
              <p className="text-lg">Winning Award</p>
            </motion.div>
          </div>
        </div>
      </section>
